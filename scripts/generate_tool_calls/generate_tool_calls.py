...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate first-round VLM tool-call annotations with the Chinese prompt format from the assignment "
            "reference prompt."
        )
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Balanced total sample count across the selected sources. Overrides the assignment default counts.",
    )
    parser.add_argument(
        "--per-source-limit",
        type=int,
        default=None,
        help="Fixed sample count to draw from each selected source. Overrides the assignment default counts.",
    )
    parser.add_argument(
        "--source-count",
        action="append",
        ...
        metavar="NAME=COUNT",
        help=(
            "Per-source sample count. Can be repeated. If omitted, defaults follow the Markdown assignment: "
...
def main() -> None:
    ...
    summary["assignment_default_counts"] = {
