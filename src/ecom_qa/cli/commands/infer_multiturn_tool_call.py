...
from ecom_qa.common.paths import data_root
from ecom_qa.common.model_client import ServerConfig, run_llama_server, write_json
from ecom_qa.tool_calls.multiturn import (
    LocalRAGSearch,
    WebSearch,
...
DEFAULT_INPUT = (
    data_root() / "tool_call_inference/generated/qwen3_vl_tool_call_full/qwen3-vl-8b/predictions.jsonl"
)
DEFAULT_OUTPUT_ROOT = data_root() / "tool_call_multiturn/generated"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--web-mode", choices=("mock", "searxng"), default="mock")
    parser.add_argument("--searxng-url", default="http://127.0.0.1:8888")
    parser.add_argument("--searxng-engines", default="google,duckduckgo,qwant,wikipedia")
...
def main() -> None:
    ...
    rag = LocalRAGSearch.from_dataset(args.data_dir, top_k=args.rag_top_k)
    web = WebSearch(
        mode=args.web_mode,
        top_k=args.web_top_k,
        base_url=args.searxng_url,
        engines=args.searxng_engines,
        summary_base_url=args.summary_url,
    ...
    print(
        f"RAG top_k={args.rag_top_k}; Web mode={args.web_mode}, top_k={args.web_top_k}; "
        f"SearXNG={args.searxng_url}, engines={args.searxng_engines}; summary={args.summary_url}"
    )
