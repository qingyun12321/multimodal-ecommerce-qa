...
DEFAULT_INPUT_JSON = Path("reports/experiments/retrieval/official_multilingual_t2i_20260403T125235Z/combined_metrics.json")
DEFAULT_OUTPUT_IMAGE = Path("official_multilingual_results_sample_style.jpg")
