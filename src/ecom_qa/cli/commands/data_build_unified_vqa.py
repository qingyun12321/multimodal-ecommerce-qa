...
DATA_DIR = data_root()
OUTPUT_DIR = DATA_DIR / "unified_vqa"
...
def main() -> None:
    ...
    sources = [
        SourceSpec(
            name="ecom_qa_pairs",
            domain="in_domain",
            source_file=DATA_DIR / "qa" / "qa_pairs.jsonl",
            image_root=DATA_DIR,
            language="zh",
        ),
        SourceSpec(
            ...
            domain="in_domain",
            source_file=DATA_DIR / "qa" / "qa_pairs_open_question.jsonl",
            image_root=DATA_DIR,
            language="zh",
        ),
        SourceSpec(
            ...
            domain="in_domain",
            source_file=DATA_DIR / "qa" / "qa_pairs_supplement.jsonl",
            image_root=DATA_DIR,
            language="zh",
        ),
        SourceSpec(
            ...
            source_file=DATA_DIR / "infoseek_sample" / "metadata.jsonl",
            image_root=DATA_DIR / "infoseek_sample",
            language="en",
        ),
    ]
