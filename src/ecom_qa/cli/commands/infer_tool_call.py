...
from ecom_qa.common.model_client import SERVER_BINARY, run_llama_server, write_json
from ecom_qa.tool_calls.inference_model import (
    DEFAULT_BATCH_SIZE,
    DEFAULT_CTX_SIZE,
    DEFAULT_MAX_TOKENS,
    DEFAULT_PARALLEL,
...
DEFAULT_INPUT = data_path("tool_call", "tool_call_records_test.jsonl")
DEFAULT_OUTPUT_ROOT = data_path("tool_call_inference", "generated")
    ...
    summary.update(
        {
            ...
            "prompt_source": "src/ecom_qa/tool_calls/generation.py::build_first_round_prompt",
        }
    )
