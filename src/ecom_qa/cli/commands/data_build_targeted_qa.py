...
from ecom_qa.common.paths import data_path, data_root
from ecom_qa.datasets.catalog import ProductRecord, load_products
from ecom_qa.qa.generation import (
    TARGET_TOOL_CLASSES,
    ServerConfig,
    TargetedQARequest,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=data_path("qa", "generated"))
        ...
        for target in args.targets:
            ...
            while generated_by_target[target] < quota:
                ...
                request = TargetedQARequest(
                    ...
                    image_path=args.data_dir / products[product_index].image_path,
